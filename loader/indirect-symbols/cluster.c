...
int nanos6_app_communicator(void)
{
	typedef int nanos6_app_communicator_t(void);

	static nanos6_app_communicator_t *symbol = NULL;
	if (__builtin_expect(symbol == NULL, 0)) {
		symbol = (nanos6_app_communicator_t *) _nanos6_resolve_symbol(
				"nanos6_app_communicator", "cluster", NULL);
	}
