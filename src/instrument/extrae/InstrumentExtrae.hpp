...
namespace Instrument {
	...
	enum struct EventType {
		...
		// [9500000:9699999] -- Nanos6-specific
			...
			// 97XXXXX -- Cluster specific events
				...
				// Hybrid MPI + OmpSs-2@Cluster
				TOTAL_APPRANK_READY_TASKS = 9800000,
				IMMOVABLE_TASKS = 9800001,
				PROMISED_TASKS = 9800002,
				OWNED_CPUS = 9800004,
				LENT_CPUS = 9800005,
				BORROWED_CPUS = 9800006,
				BUSY_CORES = 9800007,
				USEFUL_BUSY_CORES = 9800008,
				CUMUL_REQUEST_WORK = 9800009,   // deprecated
				ALLOC_CORES = 9800010,
				GIVING_CORES = 9800011,
				OFFLOAD_LIMIT = 9800012,
				OFFLOAD_HEADROOM = 9800013,
				EXTERNAL_RANK = 9800014,
				PHYSICAL_NODE_NUM = 9800015,
				APPRANK_NUM = 9800016,
	...
	typedef enum {
		...
		NANOS_PROCESSDELAYEDOPERATIONSSATISFIEDORIGINATORSANDREMOVABLETASKS,
		NANOS_DEPENDENCY_STATE_TYPES   // keep this one always at the very end
